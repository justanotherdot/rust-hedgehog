...
pub fn apply<'a, A, B, F>(gf: Gen<'a, F>, gx: Gen<'a, A>) -> Gen<'a, B>
where
    F: Fn(A) -> B + Clone + 'a,
    A: Clone + 'a,
    B: Clone + 'a,
...
pub fn map_tree<'a, F, A, B>(f: Rc<F>, g: Gen<'a, A>) -> Gen<'a, B>
where
    A: Clone + 'a,
    B: Clone + 'a,
...
pub fn resize<'a, A>(new_size: isize, g: Gen<'a, A>) -> Gen<'a, A>
where
    A: Clone + 'a,
{
    map_random(
...
pub fn bind<'a, A, B, F>(m: Gen<'a, A>, k: Rc<F>) -> Gen<'a, B>
where
    A: Clone + 'a,
    B: Clone + 'a,
    F: Fn(A) -> Gen<'a, B> + 'a,
